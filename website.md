...
| 2026-05-25 | Added og:image:width + og:image:height to all 10 page components. Verified real image dimensions and used correct values per image (1024×1024 for print_shop_team.webp and all servicio hero images; 512×512 for cropped-icono-66.png). |
