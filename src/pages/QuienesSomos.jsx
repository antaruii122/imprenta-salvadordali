...
const highlights = [
  ...
  { icon: 'ðŸ–¨ï¸', title: 'Excelente calidad', body: 'MÃ¡quinas y tintas de mercado premium para resultados de nivel profesional.' },
...
export default function QuienesSomos() {
  return (
    <main>
      <Helmet>
        <title>QuiÃ©nes Somos â€” Imprenta Profesional en Las Condes, Santiago | Imprenta Salvador DalÃ­</title>
        <meta name="description" content="Conoce nuestra historia. Imprenta en Las Condes especializada en impresiÃ³n lÃ¡ser, offset y UV. MÃ¡s de 10 aÃ±os entregando calidad y servicio express en Santiago." />
        <meta property="og:title" content="QuiÃ©nes Somos â€” Imprenta Salvador DalÃ­ Las Condes" />
        <meta property="og:description" content="Imprenta profesional en Las Condes. ImpresiÃ³n lÃ¡ser, offset y UV con entrega en 48 horas." />
      ...
      <div className="page-header">
        ...
        <div className="relative max-w-6xl mx-auto px-4 text-center">
          ...
          <h1 className="font-heading text-4xl font-bold text-charcoal">QuiÃ©nes Somos</h1>
        ...
        <div className="max-w-6xl mx-auto px-4 grid md:grid-cols-2 gap-16 items-center">
          <div className="relative">
            ...
            <div className="relative rounded-2xl overflow-hidden shadow-card-hover">
              <img src={IMG} alt="Equipo Imprenta Salvador DalÃ­"
            ...
            <div className="absolute -bottom-5 -right-5 bg-brand text-white rounded-2xl shadow-lg px-5 py-3">
              ...
              <p className="text-brand-light text-xs mt-0.5">Sistemas de impresiÃ³n</p>
            </div>
          </div>
          ...
          <div>
            ...
            <p className="text-gray-500 leading-relaxed mb-5">
              Nuestra imprenta nace del fanatismo al pintor Salvador DalÃ­. FanÃ¡ticos de su obra y estilo, quisimos honrarlo con nuestra propia marca.
            </p>
            <p className="text-gray-500 leading-relaxed mb-5">
              Dedicados a sistemas de impresiÃ³n lÃ¡ser, offset y tinta UV en diversos papeles â€” chuche, opalina, lisa, texturada, Bond, lvc, sintÃ©tico â€” y textiles. Caracterizados por servicio excepcional y entregas express de 48 horas.
            </p>
            <p className="text-gray-500 leading-relaxed">
              Ofrecemos soluciones grÃ¡ficas completas: tarjetas de presentaciÃ³n, volantes, stickers, pendones, trÃ­pticos, catÃ¡logos, merchandising y mÃ¡s.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 text-center bg-white">
        <div className="max-w-xl mx-auto px-4">
          <p className="section-label mx-auto">Â¿Listo para imprimir?</p>
          <h2 className="section-title mb-4">Â¿Tienes un proyecto?</h2>
          <p className="text-gray-500 text-sm mb-8">ContÃ¡ctanos y te damos una cotizaciÃ³n express en minutos.</p>
