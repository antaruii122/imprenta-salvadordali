  ...
  return (
    <main>
      <Helmet>
        ...
        <meta name="description" content="Compra stickers, tarjetas de presentación, volantes, pendones y etiquetas personalizadas. Imprenta en Las Condes con entrega en 48 horas." />
