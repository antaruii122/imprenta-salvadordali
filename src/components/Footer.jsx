  ...
  return (
    <footer className="bg-charcoal text-gray-300">
      ...
      <div className="max-w-6xl mx-auto px-4 py-14 grid grid-cols-1 md:grid-cols-3 gap-10">
        {/* Brand */}
        <div>
          <img src={LOGO_BEIGE} alt="Imprenta Salvador Dali" width="56" height="56" className="h-14 object-contain mb-5" />
        ...
        <div>
          ...
          <div className="space-y-2 text-sm text-gray-400">
            <p>📍 Mayecura 1177, 7570718 Las Condes, Región Metropolitana, Chile</p>
            <p><a href="tel:+56964123098" className="hover:text-white transition-colors">📞 +56 9 6412 3098</a></p>
          </div>
        </div>
      </div>

      <div className="border-t border-white/10 py-5 text-center text-xs text-gray-600">
        © {new Date().getFullYear()} Imprenta Salvador Dali · Las Condes, Santiago de Chile
      </div>
    </footer>
  )
}
